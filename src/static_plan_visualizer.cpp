 ...
 * Author: Phani Teja S
 *********************************************************************/
#define NAME "TebStaticPlanVisualizer"
#define GET_PLAN_SRV "/move_base_node/GlobalPlanner/make_plan"
#define OPTIMIZE_SRV "/move_base_node/TebLocalPlannerROS/optimize"
...
#include <teb_local_planner/static_plan_visualizer.h>
...
void StaticPlanVisualization::initialize()
{
  if(!initialized_){
    ...
    optimize_client = nh.serviceClient<teb_local_planner::Optimize>(OPTIMIZE_SRV, true);
...
void StaticPlanVisualization::UpdateStartPoses(const hanp_msgs::TrackedHumans &tracked_humans){
...
int main(int argc, char** argv)
{
  ...
  teb_local_planner::StaticPlanVisualization static_viz(tf2);
